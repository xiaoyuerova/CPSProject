...
from tcn_test_10_2.data_tcn import *
from tcn_test_10_2.data_tcn.parameters import Parameters
from tcn_test_10_2.model import CpsTcnModel
from tcn_test_10_2.utils import build_vocab_from_iterator_re, data_iter, pre_process
...
def train(train_data: Data, epoch: int):
    ...
    for idx, (labels, actions) in enumerate(train_data.dataloader):
        ...
        for j in output.argmax(1).eq(labels):
            if j:
                correct += 1
