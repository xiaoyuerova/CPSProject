...
from tcn_test_8_3.data_tcn import *
from tcn_test_8_3.data_tcn.parameters import Parameters
from tcn_test_8_3.model import CpsTcnModel
from tcn_test_8_3.utils import build_vocab_from_iterator_re, data_iter
...
def evaluate(data: Data, epoch: int):
    ...
    try:
        ...
        target_names = parameters.target_names2
